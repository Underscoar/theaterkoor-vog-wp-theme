...
function Edit(props) {
  ...
  const ALLOWED_BLOCKS = ['core/list', 'core/paragraph', 'core/heading', 'core/list', 'core/quote', 'core/details', 'core/table'];
  const removeMedia = () => {
    props.setAttributes({
      mediaId: 0,
      mediaUrl: ''
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    render: ({
      ...
      onClick: open
    }, attributes.mediaId == 0 && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Kies een afbeelding', 'awp'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
